...
figure(1)
plot(odf1,'sigma',(0:20:160)*degree,'layout',[3,3])
mtexColorMap LaboTeX

% saveFigure('../pic/ODF1.pdf','crop')


%%
figure(2)
plot(odf2,'sigma',(0:20:160)*degree,'layout',[3,3])
mtexColorMap LaboTeX


% saveFigure('../pic/ODF2.pdf','crop')
...
plotPDF(odf1,h,'contourf','layout',[3 3])
mtexColorMap LaboTeX

% saveFigure('../pic/pfODF1.pdf','crop')

%%
figure(2)
plotPDF(odf2,h,'contourf','layout',[3 3])
mtexColorMap LaboTeX

% saveFigure('../pic/pfODF2.pdf','crop')
...
plot(odf,'sigma',(0:20:160)*degree,'layout',[3 3])
mtexColorMap LaboTeX

% saveFigure('../pic/pfODF3.pdf','crop')
